...
import (
	...
	instagramcloneiov1alpha1 "github.com/Archisman-Mridha/instagram-clone/kubernetes/operators/application/pkg/apis/instagramclone.io/v1alpha1"
	versioned "github.com/Archisman-Mridha/instagram-clone/kubernetes/operators/application/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Archisman-Mridha/instagram-clone/kubernetes/operators/application/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Archisman-Mridha/instagram-clone/kubernetes/operators/application/pkg/generated/listers/instagramclone.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InstagramcloneV1alpha1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InstagramcloneV1alpha1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
		&instagramcloneiov1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&instagramcloneiov1alpha1.Application{}, f.defaultInformer)
}
