...
import (
	...
	"github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships/cmd/server/grpc/api"
	"github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships/cmd/server/grpc/api/proto/generated"
	postgres "github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships/internal/adapters/repositories/followships"
	"github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships/internal/config"
	"github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships/internal/constants"
	...
	version "github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships/version"
...
func run(ctx context.Context, config *config.Config) error {
	...
	followshipsRepositoryAdapter := postgres.NewFollowshipsRepositoryAdapter(ctx, &config.Postgres)

	followshipsService := followshipsService.NewFollowshipsService(followshipsRepositoryAdapter)
	...
	generated.RegisterFollowshipsServiceServer(gRPCServer, api.NewGRPCAPI(followshipsService))
	...
	*/
	...
	followshipsRepositoryAdapter.Shutdown()
