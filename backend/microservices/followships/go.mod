module github.com/Archisman-Mridha/instagram-clone/backend/microservices/followships

go 1.23.4

require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.36.4-20241127180247-a33202765966.1
	github.com/Archisman-Mridha/instagram-clone/backend/shared v0.0.0-20250419015027-7d90942e3119
