...
require (
	github.com/Archisman-Mridha/instagram-clone/backend/proto v0.0.0-00010101000000-000000000000
...
replace (
	github.com/Archisman-Mridha/instagram-clone/backend/proto => ../../proto
	github.com/Archisman-Mridha/instagram-clone/backend/shared => ../../shared
)
